    ...
    Node localhost {
        ...
        xScript "RunCreateVms"
        {
            SetScript = { 
                ...
                New-VM -Name "SoniaPC" -MemoryStartupBytes 2GB -Generation 1 -BootDevice VHD -VHDPath "C:\Users\Public\Documents\Hyper-V\Virtual hard disks\SuppItArchP1\SoniaPC.vhdx" -SwitchName "vSwitch"
                New-VM -Name "AdamLaptop" -MemoryStartupBytes 512MB -Generation 1 -BootDevice VHD -VHDPath "C:\Users\Public\Documents\Hyper-V\Virtual hard disks\SuppItArchP1\AdamLaptop.vhdx" -SwitchName "vSwitch"
            }
            TestScript = { $false }
            GetScript = {  
                # Do Nothing
